...
export function Header() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <header className="fixed left-0 right-0 top-0 z-50 flex h-14 items-center justify-between border-b border-black/[0.04] bg-background/80 px-4 backdrop-blur-2xl md:hidden">
        <Link href="/" className="flex items-center gap-2">
          ...
          />
          <span className="font-heading text-sm font-bold tracking-[0.15em] text-text-heading">
            LOOTOPIA
          </span>
        </Link>
